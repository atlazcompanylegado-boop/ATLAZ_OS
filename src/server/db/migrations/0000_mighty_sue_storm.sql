CREATE TYPE "public"."app_role" AS ENUM('super_admin', 'ceo', 'socio', 'desenvolvedor', 'designer', 'social_media', 'financeiro', 'comercial');--> statement-breakpoint
-- "auth"."users" já existe (gerenciada pelo Supabase Auth) — não é criada por esta migration.
-- Ela só está no schema Drizzle (src/server/db/schema/auth-users.ts) como alvo de FK.
